...
const QString BITCOIN_IPC_PREFIX("concord:");

static QString ipcServerName()
{
    QString name("Concord");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start concord: click-to-pay handler");
    else
...
{
    // clicking on concord: URLs creates FileOpen events on the Mac:
