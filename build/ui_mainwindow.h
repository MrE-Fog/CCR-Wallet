...
public:
    ...
    QAction *m_miningOnLaunchAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/icons/mining"), QSize(), QIcon::Normal, QIcon::Off);
        m_miningAction->setIcon(icon6);
        ...
        m_miningOnLaunchAction = new QAction(MainWindow);
        m_miningOnLaunchAction->setObjectName(QStringLiteral("m_miningOnLaunchAction"));
        m_miningOnLaunchAction->setCheckable(true);
        ...
        sizePolicy.setHeightForWidth(m_miningFrame->sizePolicy().hasHeightForWidth());
        m_miningFrame->setSizePolicy(sizePolicy);
        m_miningFrame->setFrameShape(QFrame::NoFrame);
        m_miningFrame->setFrameShadow(QFrame::Raised);

        gridLayout->addWidget(m_miningFrame, 1, 5, 1, 1);
        ...
        menuSettings->addAction(m_miningOnLaunchAction);
        ...
        QObject::connect(m_miningOnLaunchAction, SIGNAL(triggered(bool)), MainWindow, SLOT(setMiningOnLaunch(bool)));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        m_miningAction->setText(QApplication::translate("MainWindow", "Mining", Q_NULLPTR));
        ...
        m_miningOnLaunchAction->setText(QApplication::translate("MainWindow", "Start pool mining automatically", Q_NULLPTR));
