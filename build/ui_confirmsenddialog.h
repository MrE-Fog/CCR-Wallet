...
public:
    ...
    {
        ConfirmSendDialog->setWindowTitle(QApplication::translate("ConfirmSendDialog", "Confirm sending %1 CCR", Q_NULLPTR));
        m_confirmLabel->setText(QApplication::translate("ConfirmSendDialog", "<html><head/><body><p>Are you sure you want to send <strong>%1 CCR</strong>?</p></body></html>", Q_NULLPTR));
