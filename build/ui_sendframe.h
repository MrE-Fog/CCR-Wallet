...
public:
    ...
    void setupUi(QFrame *SendFrame)
    {
        ...
        m_mixinSlider->setSliderPosition(2);
        ...
        donateCheckBox = new QCheckBox(SendFrame);
        donateCheckBox->setObjectName(QStringLiteral("donateCheckBox"));
        donateCheckBox->setChecked(true);

        gridLayout->addWidget(donateCheckBox, 1, 3, 1, 1);
        ...
        m_donateSpin = new QDoubleSpinBox(SendFrame);
        m_donateSpin->setObjectName(QStringLiteral("m_donateSpin"));
        m_donateSpin->setMinimumSize(QSize(150, 0));
        m_donateSpin->setMaximumSize(QSize(16777215, 16777215));
        m_donateSpin->setBaseSize(QSize(150, 0));
        m_donateSpin->setCursor(QCursor(Qt::IBeamCursor));
        m_donateSpin->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        m_donateSpin->setDecimals(8);
        m_donateSpin->setMaximum(1e+15);
        m_donateSpin->setSingleStep(0.1);

        gridLayout->addWidget(m_donateSpin, 1, 4, 1, 1);
        ...
        QWidget::setTabOrder(m_feeSpin, donateCheckBox);
        QWidget::setTabOrder(donateCheckBox, m_donateSpin);
        QWidget::setTabOrder(m_donateSpin, m_paymentIdEdit);
    ...
    void retranslateUi(QFrame *SendFrame)
    {
        ...
        donateCheckBox->setText(QApplication::translate("SendFrame", "Donate 0.1% to development fund:", Q_NULLPTR));
