...
public:
    ...
    void retranslateUi(QDialog *ConnectionSettingsDialog)
    {
        ...
        label_5->setText(QApplication::translate("ConnectionSettingsDialog", "Wallet will connect to remote node running in local or global network. Please select node or specify IP address or domain name and port. In this mode wallet sends 0.25% fee from each transaction to the node, but no more than 10 CCR.", Q_NULLPTR));
    } // retranslateUi
